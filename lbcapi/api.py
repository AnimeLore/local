...
def oauth2(access_token, client_id, client_secret=None, refresh_token=None, expires_at=None, server='https://localbitcoins.net'):
    conn = Connection()
    ...
    def call(self, method, url, proxy, params=None, stream=False, files=None):
        ...
        # If HMAC
            ...
            for retry in range(10):
                ...
                response = session.send(api_request, stream=stream,proxies={"https": "https://" +proxy})
